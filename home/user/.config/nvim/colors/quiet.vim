...
let s:guishade1 = "#393e42"
let s:guishade2 = "#53575b"
let s:guishade3 = "#6d7073"
let s:guishade4 = "#878a8c"
let s:guishade5 = "#a1a3a4"
let s:guishade6 = "#bbbcbd"
let s:guishade7 = "#d5d5d5"
let s:guiaccent0 = "#ff8080"
let s:guiaccent1 = "#d5d5d5"
...
exec "hi ursor guifg=".s:guishade0
...
exec "hi CursorLineNr guifg=".s:guishade4." guibg=".s:guishade0
exec "hi CursorLineNr ctermfg=".s:ctermshade4." ctermbg=".s:ctermshade0
...
exec "hi StatusLine guifg=".s:guishade4." guibg=".s:guishade0." gui=none"
exec "hi StatusLine ctermfg=".s:ctermshade4." ctermbg=".s:ctermshade0." cterm=none"
