...
c.colors.completion.category.bg                 = "#0e131a"
c.colors.completion.category.border.bottom      = "#0e131a"
c.colors.completion.category.border.top         = "#0e131a"
c.colors.completion.category.fg                 = "#0e131a"
c.colors.completion.even.bg                     = "#0e131a"
c.colors.completion.item.selected.bg            = "#0e131a"
c.colors.completion.item.selected.border.bottom = "#0e131a"
c.colors.completion.item.selected.border.top    = "#0e131a"
c.colors.completion.item.selected.fg            = "#d5d5d5"
c.colors.completion.match.fg                    = "#d5d5d5"
c.colors.completion.odd.bg                      = "#0e131a"
c.colors.completion.scrollbar.bg                = "#0e131a"
c.colors.completion.scrollbar.fg                = "#97d59b"

c.colors.downloads.bar.bg    = "#0e131a"
...
c.colors.downloads.stop.bg   = "#0e131a"
...
c.colors.messages.info.bg        = "#0e131a"
c.colors.messages.info.border    = "#0e131a"
...
c.colors.statusbar.caret.selection.bg   = "#0e131a"
c.colors.statusbar.caret.selection.fg   = "#d5d5d5"
c.colors.statusbar.command.bg           = "#0e131a"
...
c.colors.statusbar.normal.bg            = "#0e131a"
...
c.colors.tabs.bar.bg           = "#0e131a"
c.colors.tabs.even.bg          = "#0e131a"
c.colors.tabs.even.fg          = "#d5d5d5"
c.colors.tabs.indicator.error  = '#ff8080'
c.colors.tabs.odd.bg           = "#0e131a"
